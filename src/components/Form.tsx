  ...
  return (
   <form className="flex flex-col gap-3" onSubmit={handleSubmit}>
      <div className="flex flex-col">
        ...
        />
        {error && (
          <small className="text-red-500 mt-1 text-xs">{error.name}</small>
        )}
      </div>
      <div className="flex flex-col">
        <label className="text-sn" htmlFor="email">Email</label>
        <input 
          type="email" 
          id="email"
      ...
      <div className="flex flex-col">
        <a className="text-xs mb-2 underline" href="#">Leia os termos</a>
        <div className="flex gap-2">
          <input 
            ...
            checked={agree}
          />
          <label className="text-sn" htmlFor="agree">Concordo com os termos
          </label>
        </div>
        {error && (
      ...
      <button type="submit" className="bg-slate-600 hover:bg-slate-800 font-medium trext-sn py-2 px-4 rounder-lg text-white">Cadastrar</button>
   </form>
  )
}
export default Form